...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateAuthUI(user) {
        ...
        if (user) {
            ...
            if (logoutBtnNav) {
                logoutBtnNav.addEventListener('click', handleFirebaseLogout);
            }
            // Update user name/avatar in menu if elements exist
            ...
            if (logoutBtnNav) {
                logoutBtnNav.removeEventListener('click', handleFirebaseLogout);
            }
        }
    }
